...
-m - code and data model selection
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
-ms - string and const handling
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

+--------+----------------------------------------------------------+-------------+---------------+
| Option | Description                                              | Local refs  | Remote refs   |
+========+==========================================================+=============+===============+
| -ms0   | (default) 'const' is ignored                             | n/a         | n/a           |
+--------+----------------------------------------------------------+-------------+---------------+
| -ms    | string constants and 'const' objs placed in code section | PC-relative | ABSOLUTE LONG |
+--------+----------------------------------------------------------+-------------+---------------+
| -mS    | string constants and 'const' objs placed in code section | PC-relative | PC-relative   |
+--------+----------------------------------------------------------+-------------+---------------+
...
.. warning::
    ...
    This can be dangerous and the final **code** size **must** be less than 32KBytes.
